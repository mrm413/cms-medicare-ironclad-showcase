...
019500
      ...
      /
       ...
       01  W-STORAGE-REF                  PIC X(46) VALUE
           'ESCAL130      - W O R K I N G   S T O R A G E'.
       01  CAL-VERSION                    PIC X(05) VALUE 'C13.0'.
020300
...
036100
      ...
      * used for the BUNDLED part of the Bundled Pricer.
       01  BUNDLED-BASE-PMT-RATE          PIC 9(04)V9(02) VALUE 240.36.
036500
      * The next two percentages MUST add up to 1 (i.e. 100%)
      ...
      * eliminated in 2014 when it is no longer needed.
       01  COM-CBSA-BLEND-PCT             PIC 9(01)V9(02) VALUE 0.25.
       01  BUN-CBSA-BLEND-PCT             PIC 9(01)V9(02) VALUE 0.75.
...
043700
       01  OUTLIER-SB-CALC-AMOUNTS.
           05  ADJ-AVG-MAP-AMT-LT-18      PIC 9(04)V9(02) VALUE 41.39.
           05  ADJ-AVG-MAP-AMT-GT-17      PIC 9(04)V9(02) VALUE 59.42.
           05  FIX-DOLLAR-LOSS-LT-18      PIC 9(04)V9(02) VALUE 47.32.
           05  FIX-DOLLAR-LOSS-GT-17      PIC 9(04)V9(02) VALUE 110.22.
