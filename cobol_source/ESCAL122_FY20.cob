      ...
      * ESCAL121...Note that there is NO ESCAL120 calculating
      ...
      *            version number.
      * 11/14/12- Renamed to ESCAL122. Implementation of Changes in
...
016600
      ...
      /
       ...
       01  W-STORAGE-REF                  PIC X(46) VALUE
           'ESCAL122      - W O R K I N G   S T O R A G E'.
       01  CAL-VERSION                    PIC X(05) VALUE 'C12.2'.
017400
...
021000
      ...
      * and are used for the COMPOSITE part of the Bundled Pricer.
       01  DRUG-ADDON                     PIC 9(01)V9(04) VALUE 1.1430.
       01  BASE-PAYMENT-RATE              PIC 9(04)V9(02) VALUE 141.94.
021500
...
033200
      ...
      * used for the BUNDLED part of the Bundled Pricer.
       01  BUNDLED-BASE-PMT-RATE          PIC 9(04)V9(02) VALUE 234.81.
033600
      * The next two percentages MUST add up to 1 (i.e. 100%)
      ...
      * eliminated in 2014 when it is no longer needed.
       01  COM-CBSA-BLEND-PCT             PIC 9(01)V9(02) VALUE 0.50.
       01  BUN-CBSA-BLEND-PCT             PIC 9(01)V9(02) VALUE 0.50.
...
040800
       01  OUTLIER-SB-CALC-AMOUNTS.
           05  ADJ-AVG-MAP-AMT-LT-18      PIC 9(04)V9(02) VALUE 45.44.
           05  ADJ-AVG-MAP-AMT-GT-17      PIC 9(04)V9(02) VALUE 78.00.
           05  FIX-DOLLAR-LOSS-LT-18      PIC 9(04)V9(02) VALUE 71.64.
           05  FIX-DOLLAR-LOSS-GT-17      PIC 9(04)V9(02) VALUE 141.21.
