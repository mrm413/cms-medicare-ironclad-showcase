      ...
      *           YEAR (CURRENT YEAR AND NINE PRIOR YEARS) MODE SINCE  *
...
011100
      ...
      /
       ...
       01  W-STORAGE-REF                  PIC X(46)  VALUE
           'ESCAL100      - W O R K I N G   S T O R A G E'.
       01  CAL-VERSION                    PIC X(05)  VALUE 'C10.0'.
011900
...
015300
      * THE FOLLOWING THREE VARIABLES WILL CHANGE FROM YEAR TO YEAR
       01  DRUG-ADDON                     PIC 9(01)V9(04) VALUE 1.1500.
       01  HOSP-BASED-PMT-RATE            PIC 9(04)V9(02) VALUE 135.15.
       01  INDP-ESRD-FAC-PMT-RATE         PIC 9(04)V9(02) VALUE 135.15.
015800
...
016300
      * THE NEXT TWO PERCENTAGES MUST ADD UP TO 1 (I.E. 100%)
      * They will continue to change until CY2014 WHEN
      * BUNdled CBSA will be 1.00
       01  COM-CBSA-BLEND-PCT             PIC 9(01)V9(02) VALUE 1.00.
       01  BUN-CBSA-BLEND-PCT             PIC 9(01)V9(02) VALUE 0.00.
016900
017000
      * CONSTANTS AREA
      * THE NEXT TWO PERCENTAGES MUST ADD UP TO 1 (I.E. 100%)
...
044200
           COMPUTE H-WAGE-ADJ-PYMT-NEW ROUNDED =
               (((H-PYMT-RATE * PPS-NAT-LABOR-PCT) * H-WAGE-ADJ) +
                 (H-PYMT-RATE * PPS-NAT-NONLABOR-PCT)) *
                  CBSA-BLEND-PCT.
044700
