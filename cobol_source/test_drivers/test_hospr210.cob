       ...
       PROGRAM-ID. test_hospr210.

      ******************************************************************
      * FY2021 Hospice PPS Pricer parity test driver.
      * Calls HOSPR210 directly with a synthetic claim and verifies
      * byte-for-byte parity GnuCOBOL vs Ironclad.
      ******************************************************************
       ...
       PROCEDURE DIVISION.
       MAIN-LOGIC.
           MOVE LOW-VALUES TO BILL-315-DATA

      *    Realistic-ish FY2021 Routine Home Care claim
           MOVE '1234567890' TO BILL-NPI
           MOVE '123456'     TO BILL-PROV-NO
           MOVE 20  TO BILL-FROM-CC
           MOVE 21  TO BILL-FROM-YY
           MOVE 06  TO BILL-FROM-MM
           MOVE 01  TO BILL-FROM-DD
           MOVE 20  TO BILL-ADM-CC
           MOVE 21  TO BILL-ADM-YY
           MOVE 03  TO BILL-ADM-MM
           MOVE 15  TO BILL-ADM-DD
           MOVE '11260' TO BILL-PROV-MSA-LUGAR
           MOVE '11260' TO BILL-BENE-MSA-LUGAR
           MOVE 1     TO BILL-PROV-WAGE-INDEX
           MOVE 1     TO BILL-BENE-WAGE-INDEX
           MOVE 'N'   TO BILL-QIP-IND
           MOVE '0651' TO BILL-REV1
           MOVE 'T2042' TO BILL-HCPC1
           MOVE 30    TO BILL-UNITS1
