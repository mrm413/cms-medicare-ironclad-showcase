       ...
       PROGRAM-ID. test_ltcal202.

      ******************************************************************
      * Auto-generated test driver via driver_bridge.py
      * Source program:  LTCAL202.cob
      * Called program:  LTCAL202
      ******************************************************************
...
029800
       01  BILL-NEW-DATA.
           ...
           05  B-DRG-CODE               PIC 9(03).
           05  B-LOS                    PIC 9(03).
           05  B-COV-DAYS               PIC 9(03).
           05  B-LTR-DAYS               PIC 9(02).
           05  B-CST-RPT-DAYS           PIC 9(03).
           05  B-DISCHARGE-DATE.
               10  B-DISCHG-CC          PIC 9(02).
               10  B-DISCHG-YY          PIC 9(02).
               10  B-DISCHG-MM          PIC 9(02).
               10  B-DISCHG-DD          PIC 9(02).
           05  B-COV-CHARGES            PIC 9(07)V9(02).
           05  B-SPEC-PAY-IND           PIC X(01).
           05  B-REVIEW-CODE            PIC 9(02).
           05  B-DIAGNOSIS-CODE-TABLE.
               10  B-DIAGNOSIS-CODE     PIC X(07) OCCURS 25 TIMES
                                        INDEXED BY IDX-DIAG.
           05  B-PROCEDURE-CODE-TABLE.
               10  B-PROCEDURE-CODE     PIC X(07) OCCURS 25 TIMES
                                        INDEXED BY IDX-PROC.
           05  B-LTCH-DPP-INDICATOR-SW  PIC X.
               88 B-LTCH-DPP-ADJUSTMENT VALUE 'Y'.
           05  FILLER                   PIC X(19).
033000
033100
       01  PPS-DATA-ALL.
           05  PPS-RTC.
                 88  OLD-ERROR-CODE        VALUE '50' THRU '99'.
               10  PPS-RTC-1                 PIC X.
                     88  NEW-ERROR-CODE    VALUE 'D'.
               10  PPS-RTC-2                 PIC X.
           ...
           05  PPS-DATA.
               ...
               10  PPS-SUBM-DRG-CODE         PIC X(03).
                     88  PSYCH-REHAB-DRG   VALUE
                         '876' '880' '881' '882' '883' '884'
                         '885' '887' '886' '894' '895' '896'
                         '897' '945' '946'.
           ...
           05  PPS-OTHER-DATA.
               ...
               10  PPS-IPTHRESH              PIC 9(03)V9(01).
               10  PPS-LTCH-DPP-ADJ-AMT      PIC S9(09)V99.
               10  FILLER                    PIC X(05).
063100
           05  PPS-PC-DATA.
...
064000
       01  PPS-PAYMENT-DATA.
           05  PPS-SITE-NEUTRAL-COST-PMT     PIC  9(07)V99.
           05  PPS-SITE-NEUTRAL-IPPS-PMT     PIC  9(07)V99.
           05  PPS-STANDARD-FULL-PMT         PIC  9(07)V99.
           05  PPS-STANDARD-SSO-PMT          PIC  9(07)V99.
064600
064700
       ...
       01  PROV-NEW-HOLD.
           02  PROV-NEWREC-HOLD1.
               ...
               05  P-NEW-PROVIDER-NO.
                     88  SUBCLAUSEII-PROV       VALUE '332006'.
                   10  P-NEW-STATE            PIC 9(02).
                   10  P-NEW-STATE-X REDEFINES
                       P-NEW-STATE            PIC X(02).
                   10  FILLER                 PIC X(04).
               05  P-NEW-DATE-DATA.
                   10  P-NEW-EFF-DATE.
           ...
           02  PROV-NEWREC-HOLD2.
               ...
               05  P-NEW-HOSP-QUAL-IND           PIC X(01).
...
080100
       ...
       MAIN-LOGIC.
           ...
           MOVE 01             TO B-REVIEW-CODE

           CALL 'LTCAL202' USING BILL-NEW-DATA
                                PPS-DATA-ALL
                                PPS-CBSA
                                PPS-PAYMENT-DATA
                                PRICER-OPT-VERS-SW
           ...
           DISPLAY 'PPS-STANDARD-FULL-PMT=[' PPS-STANDARD-FULL-PMT ']'
           DISPLAY 'PPS-SITE-NEUTRAL-IPPS-PMT='
