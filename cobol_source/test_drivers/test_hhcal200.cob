       ...
       PROGRAM-ID. test_hhcal200.

      ******************************************************************
      * FY2020 Home Health PPS Pricer parity test driver.
      * (HHCAL200 — older version of HH calculator)
      ******************************************************************
      ...
      *    FY2020 Home Health claim
           ...
           CALL 'HHCAL200' USING HHA-INPUT-DATA
                                  HOLD-VARIABLES-DATA
