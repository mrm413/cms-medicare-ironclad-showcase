...
035400
      ...
      /
       ...
       01  W-STORAGE-REF                  PIC X(46) VALUE
           'ESCAL191      - W O R K I N G   S T O R A G E'.
       01  CAL-VERSION                    PIC X(05) VALUE 'C19.1'.
036200
...
052200
      ...
      * used for the BUNDLED part of the Bundled Pricer.
       01  BUNDLED-BASE-PMT-RATE          PIC 9(04)V9(02) VALUE 235.27.
052600
      * The next two percentages MUST add up to 1 (i.e. 100%)
...
060300
       01  OUTLIER-SB-CALC-AMOUNTS.
           05  ADJ-AVG-MAP-AMT-LT-18      PIC 9(04)V9(02) VALUE 35.18.
           05  ADJ-AVG-MAP-AMT-GT-17      PIC 9(04)V9(02) VALUE 38.51.
           05  FIX-DOLLAR-LOSS-LT-18      PIC 9(04)V9(02) VALUE 57.14.
           05  FIX-DOLLAR-LOSS-GT-17      PIC 9(04)V9(02) VALUE 65.11.
