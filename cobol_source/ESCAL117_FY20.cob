      ...
      *           ESCAL130 Annual updates for CY 2013 made to match
      *           specifications from the Chronic Care Policy Group.
      * 11/14/12- Renamed to ESCAL117. Implementation of Changes in
      *           the ESRD Pricer for CY 2013. In addition,
      *           code was added to implement the assignment of
      *           the pediatric hemodialysis rate to
      *           revenue code 0881 (ultrafiltration) when reported
      *           on a pediatric claim (CR 7064 - Requirement #11).
      *           Changed code to add 1 to ONSET-DATE:
      *            COMPUTE ONSET-DATE = (INTEGER-LINE-ITEM-DATE -
      *                                  INTEGER-DIALYSIS-DATE) + 1
      *           in order to match ESCAL122 and ESCAL130.
      *
      ******************************************************************
       DATE-COMPILED.
...
014200
      ...
      /
       ...
       01  W-STORAGE-REF                  PIC X(46)  VALUE
           'ESCAL117      - W O R K I N G   S T O R A G E'.
       01  CAL-VERSION                    PIC X(05)  VALUE 'C11.7'.
015000
...
018600
      ...
      * and are used for the COMPOSITE part of the Bundled Pricer.
       01  DRUG-ADDON                     PIC 9(01)V9(04) VALUE 1.1470.
       01  BASE-PAYMENT-RATE              PIC 9(04)V9(02) VALUE 138.53.
019100
...
029400
      ...
      * used for the BUNDLED part of the Bundled Pricer.
       01  BUNDLED-BASE-PMT-RATE          PIC 9(04)V9(02) VALUE 229.63.
029800
      * The next two percentages MUST add up to 1 (i.e. 100%)
      ...
      * eliminated in 2014 when it is no longer needed.
       01  COM-CBSA-BLEND-PCT             PIC 9(01)V9(02) VALUE 0.75.
       01  BUN-CBSA-BLEND-PCT             PIC 9(01)V9(02) VALUE 0.25.
       01  WAIVE-CBSA-BLEND-PCT           PIC 9(01)V9(02) VALUE 1.00.
030800
      * CONSTANTS AREA
      * The next two percentages MUST add up TO 1 (i.e. 100%)
       01  BUN-NAT-LABOR-PCT              PIC 9(01)V9(05) VALUE 0.41737.
       01  BUN-NAT-NONLABOR-PCT           PIC 9(01)V9(05) VALUE 0.58263.
       01  TRAINING-ADD-ON-PMT-AMT        PIC 9(02)V9(02) VALUE 33.44.
031400
      *  The following number that is loaded into the payment equation
...
037000
       01  OUTLIER-SB-CALC-AMOUNTS.
           05  ADJ-AVG-MAP-AMT-LT-18      PIC 9(04)V9(02) VALUE 53.06.
           05  ADJ-AVG-MAP-AMT-GT-17      PIC 9(04)V9(02) VALUE 82.78.
           05  FIX-DOLLAR-LOSS-LT-18      PIC 9(04)V9(02) VALUE 195.02.
           05  FIX-DOLLAR-LOSS-GT-17      PIC 9(04)V9(02) VALUE 155.44.
...
128200
      ******************************************************************
      ***Calculate Composite Rate BSA factor (note diff superscript) ***
      ******************************************************************
...
132900
           COMPUTE H-PYMT-AMT ROUNDED = (H-WAGE-ADJ-PYMT-AMT *
              ...
              H-AGE-FACTOR * DRUG-ADDON) + A-49-CENT-PART-D-DRUG-ADJ.
133300
