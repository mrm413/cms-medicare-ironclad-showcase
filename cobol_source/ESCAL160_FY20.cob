...
030000
      ...
      /
       ...
       01  W-STORAGE-REF                  PIC X(46) VALUE
           'ESCAL160      - W O R K I N G   S T O R A G E'.
       01  CAL-VERSION                    PIC X(05) VALUE 'C16.0'.
030800
...
046700
      ...
      * used for the BUNDLED part of the Bundled Pricer.
       01  BUNDLED-BASE-PMT-RATE          PIC 9(04)V9(02) VALUE 230.39.
047100
      * The next two percentages MUST add up to 1 (i.e. 100%)
...
054500
       01  OUTLIER-SB-CALC-AMOUNTS.
           05  ADJ-AVG-MAP-AMT-LT-18      PIC 9(04)V9(02) VALUE 39.20.
           05  ADJ-AVG-MAP-AMT-GT-17      PIC 9(04)V9(02) VALUE 50.81.
           05  FIX-DOLLAR-LOSS-LT-18      PIC 9(04)V9(02) VALUE 62.19.
           05  FIX-DOLLAR-LOSS-GT-17      PIC 9(04)V9(02) VALUE 86.97.
...
097500
      ...
      * be incSB-AGE-LT-13-PD-MODEf days.  fix made 9/6/2011
