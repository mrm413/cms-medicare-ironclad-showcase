      ...
      * 11/17/15 - ESCAL160 -  specs from CM/CCPG/DCC
      * List of changes for CY 2016 -->
      * - ESRD PPS base rate
      *     Changed BUNDLED-BASE-PMT-RATE to 230.39.
      *     (Includes both a Wage Index Budget-Neutrality Adjustment
      *     Factor of 1.000495 and a Refinement Budget-Neutrality
      *     Adjustment Factor of 0.960319)
      * - Labor-related share
      *     Changed BUN-NAT-LABOR-PCT to 0.50673
      *     Full iImplementation of the revised labor-related share
      * - Non-labor-related share
      *     Changed BUN-NAT-NONLABOR-PCT to 0.49327
      *     Non-labor-related share = 1 - Labor-related share
      * - Changed ADJ-AVG-MAP-AMT-GT-17 to 50.81.
      *     For adult patients, the adjusted
      *     average outlier service MAP
      *     amount per treatment
      * - Changed ADJ-AVG-MAP-AMT-LT-18 to 39.20.
      *     For pediatric patients, the
      *     adjusted average outlier service
      *     MAP amount per treatment
      * - Changed FIX-DOLLAR-LOSS-GT-17 to 86.97.
      *     The fixed dollar loss amount for adult patients
      * - Changed FIX-DOLLAR-LOSS-LT-18 to 62.19.
      *     The fixed dollar loss amount for pediatric patients
      * - Changed values of ADULT-MULTIPLIERS
      * - Changed values of PEDIATRIC-MULTIPLIERS
      * - Added Rural Adjustment, new variables and logic
      * - Dropped Comorbids for Pneumonia & Monoclonal-Gamm
      *
      * 9/27/16 - ESCAL17B ** for BETA Testing **
      * - Implement changes from CR9598 (AKI)
      *   - new Condition Code 84 and Logic for AKI
      *       - AKI payment = Base Rate adjusted by Wage Index
      *       - skip validation of Height, Weight, Comorbid, and QIP
      *       - Reduction for AKI claims
      *   - Wage Index adjustment is only adjustment for AKI payments
      * - Added variable BSA-NATIONAL-AVERAGE that's used
      *   to calculate the BSA. It replaces the value that had been
      *   hard-coded as 1.90.
      * - Removed 5000-CALC-COMP-RATE-FACTORS because it was for
      *   Composite pricing that hasn't been used since 2013
      *
      * 10/19/2016 ESCAL170 CR9807 EFFECTIVE 1-1-17 Annual Update
      * - Changed BUNDLED-BASE-PMT-RATE to 231.55
      * - Changed TRAINING-ADD-ON-PMT-AMT to 95.60
      * - Changed ADJ-AVG-MAP-AMT-GT-17 to 45.00
      * - Changed ADJ-AVG-MAP-AMT-LT-18 to 38.29
      * - Changed FIX-DOLLAR-LOSS-GT-17 to 82.92
      * - Changed FIX-DOLLAR-LOSS-LT-18 to 68.49
      *
      * 03/15/2017 ESCAL171 CR9609 EFFECTIVE 7-1-17
      * - Added Condition Code of 87 for Retraining
      *
      * 06/14/2017 ESCAL18B BETA VERSION FOR TESTING ONLY
      * - CR10065 TDAPA calculation added
      *
      * 10/2/2017 ESCAL18C BETA VERSION FOR TESTING ONLY
      * - modify logic so TDAPA value can be passed to other modules
      *
      * 11/14/2017 ESCAL180 FOR PRODUCTION EFFECTIVE 1-1-18
      * - CR10312 Annual Update:
      *   - Changed BUNDLED-BASE-PMT-RATE to 232.37
      *   - Changed ADJ-AVG-MAP-AMT-GT-17 to 42.41
      *   - Changed ADJ-AVG-MAP-AMT-LT-18 to 37.31
      *   - Changed FIX-DOLLAR-LOSS-GT-17 to 77.54
      *   - Changed FIX-DOLLAR-LOSS-LT-18 to 47.79
      * - Put a '10' in PPS-2011-COMORBID-PAY for AKI claims
      *
      * 10/17/2018 ESCAL190 FOR PRODUCTION EFFECTIVE 1-1-19
      * - CR11021 Annual Update:
      *   - Changed BUNDLED-BASE-PMT-RATE to 235.27
      *   - Changed BUN-NAT-LABOR-PCT to 0.52300
      *   - Changed BUN-NAT-NONLABOR-PCT to 0.47700
      *   - Changed ADJ-AVG-MAP-AMT-GT-17 to 38.51
      *   - Changed ADJ-AVG-MAP-AMT-LT-18 to 35.18
      *   - Changed FIX-DOLLAR-LOSS-GT-17 to 65.11
      *   - Changed FIX-DOLLAR-LOSS-LT-18 to 57.14
      *
      * 02/04/2019 ESCAL191 - NO CHANGES TO LOGIC OR RATES
      *    - CORRECTED WAGE INDEX MEMBERS AS FOLLOWS:
      *      - REPLACED ESBUN190 WITH ESBUN191
      *      - REPLACED BUNDCBSA
      *
      * 10/09/2019 - ESCAL200 FOR PRODUCTION EFFECTIVE 1-1-20
      * - CR 11506 Annual Update
      * Implementation of Changes in the End-Stage Renal Disease (ESRD)
      * Prospective Payment System (PPS) and Payment for Dialysis
      * Furnished for Acute Kidney Injury (AKI) in ESRD Facilities for
      * Calendar Year (CY) 2020
      *
      *   - Changed BUNDLED-BASE-PMT-RATE to 239.33
      *   - Unchanged BUN-NAT-LABOR-PCT      0.52300
      *   - Unchanged BUN-NAT-NONLABOR-PCT   0.47700
      *   - Changed ADJ-AVG-MAP-AMT-GT-17 to 35.78
      *   - Changed ADJ-AVG-MAP-AMT-LT-18 to 32.32
      *   - Changed FIX-DOLLAR-LOSS-GT-17 to 48.33
      *   - Changed FIX-DOLLAR-LOSS-LT-18 to 41.04
      *
      ********************************************************
       DATE-COMPILED.
...
037000
      ...
      /
       ...
       01  W-STORAGE-REF                  PIC X(46) VALUE
           'ESCAL200      - W O R K I N G   S T O R A G E'.
       01  CAL-VERSION                    PIC X(05) VALUE 'C20.0'.
037800
...
050800
           ...
           05  H-BUN-RURAL-MULTIPLIER     PIC 9(01)V9(03).
           05  H-TDAPA-PAYMENT            PIC 9(07)V9(04).
051600
...
055200
      * CONSTANTS AREA
      * The next two percentages MUST add up TO 1 (i.e. 100%)
       01  BUN-NAT-LABOR-PCT              PIC 9(01)V9(05) VALUE 0.52300.
       01  BUN-NAT-NONLABOR-PCT           PIC 9(01)V9(05) VALUE 0.47700.
       01  TRAINING-ADD-ON-PMT-AMT        PIC 9(02)V9(02) VALUE 95.60.
055800
      *  The following number that is loaded into the payment equation
...
056300
      * Added a constant to hold the BSA-National-Average that is used
      * in the BSA Calculation. This value changes every five years.
       01 BSA-NATIONAL-AVERAGE            PIC 9(01)V9(02) VALUE 1.90.
056700
       01  PEDIATRIC-MULTIPLIERS.
      *Separately billable payment multiplier (used for outliers)
           05  PED-SEP-BILL-PAY-MULTI.
               10  SB-AGE-LT-13-PD-MODE   PIC 9(01)V9(03) VALUE 0.410.
               10  SB-AGE-LT-13-HEMO-MODE PIC 9(01)V9(03) VALUE 1.406.
               10  SB-AGE-13-17-PD-MODE   PIC 9(01)V9(03) VALUE 0.569.
               10  SB-AGE-13-17-HEMO-MODE PIC 9(01)V9(03) VALUE 1.494.
           05  PED-EXPAND-BUNDLE-PAY-MULTI.
      *Expanded bundle payment multiplier (used for normal billing)
               10  EB-AGE-LT-13-PD-MODE   PIC 9(01)V9(03) VALUE 1.063.
               10  EB-AGE-LT-13-HEMO-MODE PIC 9(01)V9(03) VALUE 1.306.
               10  EB-AGE-13-17-PD-MODE   PIC 9(01)V9(03) VALUE 1.102.
               10  EB-AGE-13-17-HEMO-MODE PIC 9(01)V9(03) VALUE 1.327.
058100
       01  ADULT-MULTIPLIERS.
      *Separately billable payment multiplier (used for outliers)
           05  SEP-BILLABLE-PAYMANT-MULTI.
               10  SB-AGE-18-44           PIC 9(01)V9(03) VALUE 1.044.
               10  SB-AGE-45-59           PIC 9(01)V9(03) VALUE 1.000.
               10  SB-AGE-60-69           PIC 9(01)V9(03) VALUE 1.005.
               10  SB-AGE-70-79           PIC 9(01)V9(03) VALUE 1.000.
               10  SB-AGE-80-PLUS         PIC 9(01)V9(03) VALUE 0.961.
               10  SB-BSA                 PIC 9(01)V9(03) VALUE 1.000.
               10  SB-BMI-LT-18-5         PIC 9(01)V9(03) VALUE 1.090.
               10  SB-ONSET-LE-120        PIC 9(01)V9(03) VALUE 1.409.
               10  SB-PERICARDITIS        PIC 9(01)V9(03) VALUE 1.209.
      *        10  SB-PNEUMONIA           PIC 9(01)V9(03) VALUE 1.422.
               10  SB-GI-BLEED            PIC 9(01)V9(03) VALUE 1.426.
               10  SB-SICKEL-CELL         PIC 9(01)V9(03) VALUE 1.999.
               10  SB-MYELODYSPLASTIC     PIC 9(01)V9(03) VALUE 1.494.
      *        10  SB-MONOCLONAL-GAMM     PIC 9(01)V9(03) VALUE 1.074.
               10  SB-LOW-VOL-ADJ-LT-4000 PIC 9(01)V9(03) VALUE 0.955.
               10 SB-RURAL               PIC 9(01)V9(03) VALUE 0.978.
      *Case-Mix adjusted payment multiplier (used for normal billing)
           05  CASE-MIX-PAYMENT-MULTI.
               10  CM-AGE-18-44           PIC 9(01)V9(03) VALUE 1.257.
               10  CM-AGE-45-59           PIC 9(01)V9(03) VALUE 1.068.
               10  CM-AGE-60-69           PIC 9(01)V9(03) VALUE 1.070.
               10  CM-AGE-70-79           PIC 9(01)V9(03) VALUE 1.000.
               10  CM-AGE-80-PLUS         PIC 9(01)V9(03) VALUE 1.109.
               10  CM-BSA                 PIC 9(01)V9(03) VALUE 1.032.
               10  CM-BMI-LT-18-5         PIC 9(01)V9(03) VALUE 1.017.
               10  CM-ONSET-LE-120        PIC 9(01)V9(03) VALUE 1.327.
               10  CM-PERICARDITIS        PIC 9(01)V9(03) VALUE 1.040.
      *        10  CM-PNEUMONIA           PIC 9(01)V9(03) VALUE 1.135.
               10  CM-GI-BLEED            PIC 9(01)V9(03) VALUE 1.082.
               10  CM-SICKEL-CELL         PIC 9(01)V9(03) VALUE 1.192.
               10  CM-MYELODYSPLASTIC     PIC 9(01)V9(03) VALUE 1.095.
      *        10  CM-MONOCLONAL-GAMM     PIC 9(01)V9(03) VALUE 1.024.
               10  CM-LOW-VOL-ADJ-LT-4000 PIC 9(01)V9(03) VALUE 1.239.
               10 CM-RURAL               PIC 9(01)V9(03) VALUE 1.008.
061900
       01  OUTLIER-SB-CALC-AMOUNTS.
           05  ADJ-AVG-MAP-AMT-LT-18      PIC 9(04)V9(02) VALUE 32.32.
           05  ADJ-AVG-MAP-AMT-GT-17      PIC 9(04)V9(02) VALUE 35.78.
           05  FIX-DOLLAR-LOSS-LT-18      PIC 9(04)V9(02) VALUE 41.04.
           05  FIX-DOLLAR-LOSS-GT-17      PIC 9(04)V9(02) VALUE 48.33.
...
069500
069600
      * ESRD PC PRICER USES NEXT FOUR LINES TO INITIALIZE VALUES
      * THAT IT NEEDS TO DISPLAY DETAILED RESULTS
...
070800
      ...
      * Calculate payment for AKI claim
              ...
              ELSE
      * Calculate payment for ESRD claim
...
072400
      ...
      /
       1000-VALIDATE-BILL-ELEMENTS.
           IF PPS-RTC = 00  THEN
              IF B-COND-CODE NOT = '73' AND '74' AND '84' AND
                                   '87' AND '  '
                 MOVE 58                  TO PPS-RTC
              END-IF
           END-IF.
...
083000
           IF PPS-RTC = 00  THEN
              ...
              END-IF
           END-IF.
      *OLD WAY OF VALIDATING COMORBIDS
      *    IF PPS-RTC = 00  THEN
      ...
      *    END-IF.
      *
      *CY2016 - DROP PNEUMONIA & MONOCLONAL GAMM COMORBIDS
084700
           IF PPS-RTC = 00  THEN
              IF B-COND-CODE NOT = '84' THEN
                 IF COMORBID-CWF-RETURN-CODE = SPACES OR
...
086500
      ******************************************************************
      ***Calculate BUNDLED Wage Adjusted Rate                        ***
      ******************************************************************
...
199900
           ...
           END-IF.
201800
      *ESRD PC PRICER NEEDS BUNDLED-TEST-INDIC SET TO "T" IN ORDER TO BE
      *TO PASS VALUES FOR DISPLAYING DETAILED RESULTS FROM BILL-DATA-TES
      *BUNDLED-TEST-INDIC IS NOT SET TO "T"  IN THE PRODUCTION SYSTEM (F
           IF BUNDLED-TEST   THEN
